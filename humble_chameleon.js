module.exports = {
  ...
  humbleProxy: function(victim_request, humble_response) {
	...
	try {
          ...
          set_cookies.push(config[humble_domain].tracking_cookie + "=" + tracking_value + ";domain=" + humble_domain + ";Path=/;Secure;httponly;max-age=31536000")
          ...
          try{
            ...
            set_cookies.push(config[humble_domain].tracking_cookie + "=" + "rogue_click" + ";domain=" + humble_domain + ";Path=/;Secure;httponly;max-age=31536000")
	  }
          set_cookie = false
